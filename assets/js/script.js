	...
	function locationSuccess(position) {
		...
		try{
			...
			if(cache && cache.timestamp && cache.timestamp > d.getTime() - 30*60*1000){
				...
				var weatherAPI = `https://api.openweathermap.org/data/2.5/forecast?lat=${position.coords.latitude}&lon=${position.coords.longitude}&appid=${"cf8ca3df282c603789ae4d2a8506d06a"}&callback=?`
